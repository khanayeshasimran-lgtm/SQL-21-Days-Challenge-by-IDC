...
SELECT * FROM patients LIMIT 5 OFFSET 0;

-- Show patients 11-20 using OFFSET.
SELECT * FROM patients LIMIT 10 OFFSET 10;

/*Get the 10 most recent patient admissions based on 
arrival_date*/
SELECT patient_id, name, age, arrival_date
FROM patients
ORDER BY arrival_date DESC
LIMIT 10;

/* Find the 3rd to 7th highest patient satisfaction scores 
from the patients table, showing patient_id, name, service, 
